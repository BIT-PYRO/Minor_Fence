...
public class StudentDashboardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        markAttendanceButton.setOnClickListener(v -> {
            if (isWithinAllowedTime()) {
                ...
                Toast.makeText(this, "Attendance can only be marked between 10:00 PM and 10:30 PM.", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private boolean isWithinAllowedTime() {
        ...
        int allowedStartTime = (ALLOWED_START_HOUR * 60) + ALLOWED_START_MINUTE; // 10:00 PM in minutes
        int allowedEndTime = (ALLOWED_END_HOUR * 60) + ALLOWED_END_MINUTE; // 10:30 PM in minutes
